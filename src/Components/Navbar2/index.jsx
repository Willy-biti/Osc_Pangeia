        ...
        <IconContext.Provider value={{ color: '#f1f1f1' }}>
            <Nav $scrollNav={scrollNav}>
                <NavbarContainer>
                    ...
                    <NavMenu>
                        <NavItem>
                            <NavLinks to="#">Sobre nós<FaAngleDown style={{color: '#F5F5F5' }} /></NavLinks>
                            <SubMenu>
                        ...
                        <NavItem>
                            <NavLinks  to="#">Galeria  <FaAngleDown style={{color: '#F5F5F5' }} /></NavLinks>
                            <SubMenu>
                        ...
                        <NavItem>
                            <NavLinks  to="#">Eventos <FaAngleDown style={{color: '#F5F5F5' }} /></NavLinks>
                            <SubMenu>
